                    ...
                    {view === "history" ? (
                        ...
                        <div className="flex h-full flex-col items-center justify-center px-1 text-center">
                            <div className="relative font-serif text-4xl font-bold italic tracking-normal" style={{ color: theme.node.text }}>
                                <span>朋克</span>
                                <DiaTextReveal className="absolute inset-0" colors={["#A97CF8", "#F38CB8", "#FDCC92"]} textColor="transparent" duration={1.8} startOnView={false} text="朋克" />
                            </div>
                            <div className="mt-3 font-serif text-base italic tracking-wide opacity-60">一个入口，生成更多想法</div>
                        </div>
                    )}
                </div>
        ...
        <div className="px-2 pb-2" onWheelCapture={(event) => event.stopPropagation()}>
            ...
            <div className="rounded-[28px] border px-3 pb-3 pt-3 shadow-lg" style={{ background: theme.toolbar.panel, borderColor: theme.node.stroke }}>
                <textarea
                    ...
                    className="thin-scrollbar min-h-20 max-h-[min(40vh,480px)] w-full resize-y border-0 bg-transparent px-1 py-1 text-sm leading-5 outline-none placeholder:text-stone-400"
